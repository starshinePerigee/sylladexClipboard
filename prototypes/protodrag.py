...
ROOM_PATH = r"C:\Users\McGiffenK\Desktop\testpy\sylladex\prototypes\room.png"
...
class DragCanvas(wx.Frame):
    def __init__(self, parent, ID):
        ...
        card_image = wx.Image(IMAGE_PATH, wx.BITMAP_TYPE_PNG)
        card_bmp = wx.Bitmap(card_image)
        punched_image = wx.Image(PUNCHED_PATH, wx.BITMAP_TYPE_PNG)
        punched_bmp = wx.Bitmap(punched_image)
        room_image = wx.Image(ROOM_PATH, wx.BITMAP_TYPE_PNG)
        room_bmp = wx.Bitmap(room_image)

        self.SetCursor(wx.Cursor(wx.CURSOR_ARROW))
        self.bg_bmp = room_bmp
